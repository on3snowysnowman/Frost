...
private:
    ...
    SDL_Rect src; // Dimensions to splice from the font atlas when rendering a character.
    SDL_Rect dest; // Dimensions to place character on screen when rendering a character.
